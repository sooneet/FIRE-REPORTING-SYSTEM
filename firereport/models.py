...
class Teams(models.Model):
    ...
    teamLeaderName = models.CharField(max_length=200,null=True)
    teamLeadMobno = models.CharField(max_length=200,null=True)
...
class Firereport(models.Model):
    ...
    AssignTo = models.ForeignKey(Teams,  on_delete=models.CASCADE)
